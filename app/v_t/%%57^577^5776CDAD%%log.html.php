<?php /* Smarty version 2.6.26, created on 2013-09-17 10:19:18
  ...
  <div class="content-box">
    <div class="content-box-header">
      ...
      <ul class="content-box-tabs">
        <li><a href="<?php echo smarty_function_get_url(array('rule' => "/system/log",'data' => "type=0"), $this);?>
" <?php if ($this->_tpl_vars['type'] == 0): ?>class="default-tab"<?php endif; ?>>新增商品记录</a></li>
        <li><a href="<?php echo smarty_function_get_url(array('rule' => "/system/log",'data' => "type=1"), $this);?>
" <?php if ($this->_tpl_vars['type'] == 1): ?>class="default-tab"<?php endif; ?>>入库记录</a></li>
        <li><a href="<?php echo smarty_function_get_url(array('rule' => "/system/log",'data' => "type=2"), $this);?>
" <?php if ($this->_tpl_vars['type'] == 2): ?>class="default-tab"<?php endif; ?>>销售记录</a></li>
      </ul>
      <div class="clear"></div>
    </div>
