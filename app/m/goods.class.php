...
class m_goods extends base_m {
	...
	public function create($data) {
		...
		$this->set ( "promote_price", $data ['promote_price']?$data ['promote_price']:0 );
		$this->set ( "ispromote", $data ['ispromote'] );
		$this->set ( "promote_start_date", $data ['promote_start_date']?$data ['promote_start_date']:"0000-00-00" );
		$this->set ( "promote_end_date", $data ['promote_end_date']?$data ['promote_end_date']:"0000-00-00" );
